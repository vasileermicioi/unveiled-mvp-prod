/* eslint-disable */
// Generated by Wrangler by running `wrangler --config wrangler.app.toml types` (hash: 2ea288ed0f8c26654cd6375bd4866f8d)
// Runtime types generated with workerd@1.20260504.1 2026-05-06 global_fetch_strictly_public,no_handle_cross_request_promise_resolution,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PUBLIC_BETTER_AUTH_URL" | "PUBLIC_APP_URL" | "NODE_ENV" | "DATABASE_URL" | "RESEND_API_KEY" | "DAILY_CODES_FROM_EMAIL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "PUBLIC_STRIPE_PUBLISHABLE_KEY" | "STRIPE_PRICE_BASIC_BERLIN" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "PUBLIC_ASSET_BASE_URL" | "CLOUDFLARE_API_TOKEN" | "PARITY_TEST_DATABASE_URL">> {}
}
