import { Alert as HeroUIAlert } from "@nextui-org/react";
import {
  createContext,
  useCallback,
  useContext,
...
const TONE_TO_HERO_COLOR: Record<ToastTone, "default" | "success" | "warning" | "danger"> = {
  default: "default",
  success: "success",
  warning: "warning",
  danger: "danger",
...
export function ToastProvider({ children }: PropsWithChildren) {
  ...
  const value = useMemo<ToastContextValue>(
    () => ({
      ...
      info: (title, description) => push({ title, description, tone: "default" }),
    }),
    [push],
  );
