...
export const AdminErrorSchema = z
  ...
  .describe("Admin error envelope.");

// Auto-generated from OpenAPI schema Admin.AssetUploadResult. Do not edit.

export const AssetUploadResultSchema = z
  .object({
    url: z.string().describe("Public URL of the stored asset."),
    key: z.string().describe("Object key inside the R2 bucket."),
    kind: z.any().describe("Asset kind discriminator."),
    size: z.number().int().describe("Byte size of the uploaded object."),
    contentType: z.string().describe("Validated content type."),
  })
  .describe("Asset upload success result.");
...
export const EventSchema = z
  .object({
    ...
    secretCodeMode: z.enum(["PASSWORD", "CODE"]).optional(),
    eventWebsiteUrl: z.string().optional(),
    createdAt: z.any(),
    updatedAt: z.any(),
  })
  .describe("Event record exposed over the wire.");
...
export const PartnerSchema = z
  ...
  .describe("Partner record exposed over the wire.");

// Auto-generated from OpenAPI schema AstroActions.AdminTicketInput. Do not edit.

export const AdminTicketInputSchema = z.object({
  userId: z.any(),
  eventId: z.any(),
  ticketQuantity: z.number().int(),
  consumeCapacity: z.boolean(),
  debitCredits: z.boolean(),
...
export const EventFormInputSchema = z.object({
  ...
  eventWebsiteUrl: z.string().optional(),
  seriesLength: z.number().int().optional(),
  seriesIntervalDays: z.number().int().optional(),
});

// Auto-generated from OpenAPI schema AstroActions.GetAdminExportRowsInput. Do not edit.

export const GetAdminExportRowsInputSchema = z.object({
  partnerId: z.any().optional(),
...
export const GetPartnerBookingExportRowsInputSchema = z.object({
...
export const PartnerFormInputSchema = z.object({
  id: z.any().optional(),
  name: z.string(),
  contactEmail: z.any(),
  contactPhone: z.any().optional(),
...
export const PartnerPortalAccessInputSchema = z.object({
  partnerId: z.any(),
  email: z.any(),
  name: z.string(),
});
...
export const ToggleUserFreezeInputSchema = z.object({
  userId: z.any(),
  frozen: z.boolean(),
  reason: z.string().optional(),
});
...
export const TrackEventOpenInputSchema = z.object({
  eventId: z.any(),
  viewName: z.string(),
});
...
export const TrackFilterApplyInputSchema = z.object({
...
export const VenueQrCheckInInputSchema = z.object({
  partnerId: z.any(),
  venueToken: z.string(),
});
...
export const AccountMeSchema = z
  .object({
    user: z.any().describe("The authenticated user."),
    profile: z.any().describe("The user's profile."),
  })
  .describe("Account me response (placeholder for 09-iteration).");

// Auto-generated from OpenAPI schema Auth.AuthResult. Do not edit.

export const AuthResultSchema = z
  .object({
    state: z.any().describe("Auth state envelope."),
    user: z
      .any()
      .describe("Authenticated user, when login/signup succeeded.")
      .optional(),
    session: z
      .any()
      .describe("Newly created session, when login/signup succeeded.")
      .optional(),
    nextPath: z
      .string()
      .describe("Path to navigate to after success.")
      .optional(),
  })
  .describe("Generic auth result with optional user/session and next path.");

// Auto-generated from OpenAPI schema Auth.AuthState. Do not edit.

export const AuthStateSchema = z
  .object({
    ok: z.boolean().describe("True when authentication succeeded."),
    status: z
      .enum([
        "idle",
        "loading",
    ...
    message: z.string().describe("Top-level error message.").optional(),
    fieldErrors: z
      .record(z.string(), z.any())
      .describe("Optional field-level error map.")
      .optional(),
    nextPath: z.string().describe("Redirect target after success.").optional(),
  })
  .describe("Auth state used in API responses.");
...
export const BillingAddressSchema = z
  ...
  .describe("Billing address fields stored on the profile.");

// Auto-generated from OpenAPI schema Auth.LoginRequest. Do not edit.

export const LoginRequestSchema = z
  .object({
    email: z.any().describe("User email."),
    password: z.string().describe("User password (min 8 characters)."),
    callbackURL: z
      .string()
      .describe("Optional URL to redirect to after success.")
      .optional(),
  })
...
export const LogoutRequestSchema = z
  .object({
    _placeholder: z
      .string()
      .describe("Empty marker for the logout endpoint.")
      .optional(),
  })
  .describe("Logout request body (empty).");

// Auto-generated from OpenAPI schema Auth.PasswordRecoveryRequest. Do not edit.

export const PasswordRecoveryRequestSchema = z
  .object({
    email: z.any().describe("Email address to send the recovery link to."),
    redirectTo: z
      .string()
      .describe("Optional URL the recovery link redirects to.")
      .optional(),
  })
  .describe("Password recovery request body.");

// Auto-generated from OpenAPI schema Auth.Profile. Do not edit.

export const ProfileSchema = z
  .object({
    userId: z.any().describe("Profile id (matches user id)."),
    firstName: z.string().describe("First name, may be empty.").optional(),
    lastName: z.string().describe("Last name, may be empty.").optional(),
    language: z.any().describe("Preferred UI language."),
    avatarUrl: z.string().describe("Optional display avatar URL.").optional(),
    newsletterOptIn: z
      .boolean()
      .describe("Whether the user opted into the newsletter."),
    credits: z
      .number()
      .int()
      .describe("Available booking credits, may be negative when frozen."),
  })
  .describe("Localized user-facing profile fields.");

// Auto-generated from OpenAPI schema Auth.Session. Do not edit.

export const SessionSchema = z
  .object({
    id: z.any().describe("Session id."),
    userId: z.any().describe("Session owner user id."),
    createdAt: z.any().describe("Session creation timestamp."),
    expiresAt: z.any().describe("Session expiry timestamp."),
  })
  .describe("Active session summary.");
...
export const UpdateProfileRequestSchema = z
  ...
  .describe("Profile update request (placeholder for 09-iteration).");

// Auto-generated from OpenAPI schema Auth.User. Do not edit.

export const UserSchema = z
  .object({
    id: z.any().describe("Stable user identifier."),
    email: z.any().describe("Primary email address."),
    name: z.string().describe("Display name derived from the user profile."),
    role: z.any().describe("Account role."),
    frozen: z
      .boolean()
      .describe("True when the account is frozen by an admin override."),
  })
  .describe("Account identity record exposed over the wire.");

// Auto-generated from OpenAPI schema Common.ApiError. Do not edit.

export const ApiErrorSchema = z
  .object({
    message: z.string().describe("Top-level error message, safe to display."),
    fieldErrors: z
      .record(z.string(), z.any())
      .describe("Optional field-level error map for form submissions.")
      .optional(),
  })
  .describe("Generic API error envelope returned for any non-2xx response.");

// Auto-generated from OpenAPI schema Common.AssetKind. Do not edit.

export const AssetKindSchema = z
  .enum(["EVENT", "PARTNER", "AVATAR"])
  .describe("Asset upload kind discriminator.");

// Auto-generated from OpenAPI schema Common.BookingState. Do not edit.

export const BookingStateSchema = z
  .enum(["CONFIRMED", "WAITLIST", "REJECTED"])
  .describe("Booking confirmation state.");
...
export const CreditLedgerEntryTypeSchema = z
  .enum(["PLAN_REFILL", "BOOKING_DEBIT", "ADMIN_ADJUST", "REFUND", "EXPIRY"])
  .describe("Credit ledger entry type.");
...
export const EmailSchema = z
  .string()
  .email()
  .describe("Email address (RFC 5322).");
...
export const LanguageSchema = z
  .enum(["DE", "EN"])
  .describe("ISO-639-1 language code with custom DE/EN enum.");
...
export const LocalizedStringSchema = z
  ...
  .describe("Localized text values for DE and EN.");

// Auto-generated from OpenAPI schema Common.PaginationInput. Do not edit.

export const PaginationInputSchema = z
  .object({
    page: z.number().int().gte(1).describe("1-indexed page number.").default(1),
    pageSize: z
      .number()
      .int()
      .gte(1)
      .lte(100)
      .describe("Page size, capped at 100 by the handler.")
      .default(20),
  })
  .describe("Pagination request parameters for list endpoints.");
...
export const PaginationMetaSchema = z
  .object({
    totalCount: z
      .number()
      .int()
      .describe("Total row count matching the query."),
    hasMore: z
      .boolean()
      .describe("True when more pages are available after the current page."),
  })
  .describe("Pagination metadata returned with paginated responses.");

// Auto-generated from OpenAPI schema Common.PhoneNumber. Do not edit.

export const PhoneNumberSchema = z
  .string()
  .describe("E.164 phone number or empty string when not provided.");

// Auto-generated from OpenAPI schema Common.Role. Do not edit.

export const RoleSchema = z
  .enum(["GUEST", "MEMBER", "PARTNER", "ADMIN"])
  .describe("User role within the application.");
...
export const SubscriptionStatusSchema = z
  ...
  .describe("Subscription status reported by the billing provider.");

// Auto-generated from OpenAPI schema Common.TicketType. Do not edit.

export const TicketTypeSchema = z
  .enum(["PUBLIC", "INVITE_ONLY", "VOUCHER", "SECRET_CODE", "FREE"])
  .describe("Event ticket type.");
...
export const WaitlistStatusSchema = z
  .enum(["PENDING", "PROMOTED", "EXPIRED", "CANCELLED"])
  .describe("Waitlist entry status.");

// Auto-generated from OpenAPI schema Member.AdminSurface. Do not edit.

export const AdminSurfaceSchema = z
  .object({
    events: z.array(z.any()),
    partners: z.array(z.any()),
    members: z.array(z.any()),
    dashboardCounts: z.object({
...
export const BookingSchema = z
  .object({
    ...
    checkedInAt: z.any().optional(),
    createdAt: z.any(),
    creditsSpent: z.number().int(),
  })
  .describe("Booking record exposed over the wire.");
...
export const CreditLedgerEntrySchema = z
  .object({
    ...
    relatedEventId: z.any().optional(),
    relatedBookingId: z.any().optional(),
    createdAt: z.any(),
  })
...
export const MemberSurfaceSchema = z
  .object({
    user: z.any(),
    profile: z.any(),
    bookings: z.array(z.any()),
    waitlist: z.array(z.any()),
    savedEvents: z.array(z.any()),
    ledger: z.array(z.any()),
  })
  .describe("Member surface result.");

// Auto-generated from OpenAPI schema Member.PartnerSurface. Do not edit.

export const PartnerSurfaceSchema = z
  .object({
    partner: z.any(),
    events: z.array(z.any()),
    guestList: z.array(z.any()),
    qrPath: z.string(),
    qrTokenStatus: z.string(),
    exportAvailable: z.boolean(),
  })
  .describe("Partner surface result.");

// Auto-generated from OpenAPI schema Member.PublicDiscoverySurface. Do not edit.

export const PublicDiscoverySurfaceSchema = z
  .object({
    events: z.array(z.any()),
  ...
  .describe("Public discovery surface result.");

// Auto-generated from OpenAPI schema Member.SavedEvent. Do not edit.

export const SavedEventSchema = z
  .object({
    userId: z.any(),
    eventId: z.any(),
    eventTitle: z.string(),
  ...
  .describe("Saved event reference.");
...
export const WaitlistEntrySchema = z
  ...
  .describe("Waitlist entry exposed over the wire.");

// Auto-generated from OpenAPI schema Partner.PartnerCheckInRequest. Do not edit.

export const PartnerCheckInRequestSchema = z
  .object({ bookingId: z.any().describe("Booking id to check in.") })
  .describe("Partner check-in request.");

// Auto-generated from OpenAPI schema Partner.PartnerCheckInResult. Do not edit.

export const PartnerCheckInResultSchema = z
  .object({
    bookingId: z.any().describe("Booking id that was checked in."),
    partnerId: z.any().describe("Partner id that owns the check-in."),
    message: z.string().describe("Localized success message."),
  })
  .describe("Partner check-in result.");

// Auto-generated from OpenAPI schema Partner.PartnerExportInput. Do not edit.

export const PartnerExportInputSchema = z
  .object({ eventId: z.any().optional() })
  .describe("Partner export filter input.");

// Auto-generated from OpenAPI schema Partner.PartnerExportRow. Do not edit.

export const PartnerExportRowSchema = z
  .object({
    bookingId: z.any(),
  ...
  .describe("Partner export row.");

// Auto-generated from OpenAPI schema Partner.PartnerGuestRow. Do not edit.

export const PartnerGuestRowSchema = z
  .object({
    bookingId: z.any(),
    guestShortId: z.string(),
    userShortId: z.string(),
    eventTitle: z.string(),
    redemptionCode: z.string().optional(),
    status: z.any(),
  ...
  .describe("Guest row for the partner portal guest list.");

// Auto-generated from OpenAPI schema Partner.PartnerPortal. Do not edit.

export const PartnerPortalSchema = z
  .object({
    partner: z.any(),
    events: z.array(z.any()),
    guestList: z.array(z.any()),
    qrPath: z.string(),
    venueToken: z.string(),
    aggregateGuests: z.number().int(),
    exportAvailable: z.boolean(),
  })
  .describe("Partner portal home data.");

// Auto-generated from OpenAPI schema Partner.VenueQrCheckInRequest. Do not edit.

export const VenueQrCheckInRequestSchema = z
  .object({ partnerId: z.any(), venueToken: z.string() })
  .describe("Venue QR check-in request.");

// Auto-generated from OpenAPI schema Partner.VenueQrCheckInResult. Do not edit.

export const VenueQrCheckInResultSchema = z
  .object({
    bookingId: z.any(),
    partnerId: z.any(),
    userId: z.any(),
  ...
  .describe("Venue QR check-in result.");

// Auto-generated from OpenAPI schema Surfaces.AdminInput. Do not edit.

export const AdminInputSchema = z
  .object({
    membersPage: z.number().int().optional(),
    membersPageSize: z.number().int().optional(),
    partnersPage: z.number().int().optional(),
    partnersPageSize: z.number().int().optional(),
    eventsPage: z.number().int().optional(),
    eventsPageSize: z.number().int().optional(),
  })
  .describe("Admin surface input.");
...
export const MemberInputSchema = z
  ...
  .describe("Member surface input.");

// Auto-generated from OpenAPI schema Surfaces.PartnerInput. Do not edit.

export const PartnerInputSchema = z
  .object({ partnerId: z.any() })
  .describe("Partner surface input.");

// Auto-generated from OpenAPI schema Surfaces.PublicDiscoveryInput. Do not edit.

export const PublicDiscoveryInputSchema = z
  .object({
    q: z.string().describe("Search query string.").optional(),
    category: z.string().describe("Category filter.").optional(),
    district: z.string().describe("District filter.").optional(),
    date: z.string().describe("Date filter (ISO-8601).").optional(),
    page: z.number().int().describe("Page number (1-indexed).").optional(),
    pageSize: z.number().int().describe("Page size.").optional(),
  })
  .describe("Public discovery surface input.");

// Auto-generated from OpenAPI schema Surfaces.Surface. Do not edit.

export const SurfaceSchema = z
  .union([z.any(), z.any(), z.any(), z.any()])
  .describe(
    "Closed union of registered data-access surfaces (one per loader in `src/lib/data-access/loaders.ts`).",
  );
...
export const HealthResultSchema = z
  .object({
    status: z.literal("ok").describe("`ok` when the worker is responsive."),
    now: z.any().describe("Server timestamp."),
  })
  .describe("Liveness probe result.");
...
export const ReadinessResultSchema = z
  .object({
    status: z
      .enum(["ready", "degraded"])
      .describe("`ready` when dependencies are reachable."),
    checks: z
      .record(z.string(), z.any())
      .describe("Per-dependency status map."),
  })
  .describe("Readiness probe result.");

// Auto-generated from OpenAPI schema Webhooks.ProviderEvent. Do not edit.

export const ProviderEventSchema = z
  .object({
    provider: z.string().describe("Provider identifier (e.g. `stripe`)."),
    eventId: z.string().describe("Provider event id (e.g. `evt_...`)."),
    type: z.string().describe("Event type reported by the provider."),
    payload: z
      .any()
      .describe("Raw event payload as received from the provider."),
    receivedAt: z.any().describe("Receipt timestamp."),
    processed: z.boolean().describe("True once the event has been processed."),
  })
  .describe("Provider event record persisted for idempotency.");
...
export const StripeCustomerSchema = z
  .object({
    ...
    invoice_settings: z
      .object({ default_payment_method: z.string().optional() })
      .optional(),
  })
  .describe("Stripe customer (subset of Stripe API response).");
...
export const StripeEventSchema = z
  .union([
    ...
    z.object({
      type: z.enum(["payment_method.attached", "payment_method.detached"]),
      data: z.object({ object: z.any() }),
    }),
    z.object({
  ...
  .describe("Discriminated union of supported Stripe event types.");
...
export const StripeInvoiceSchema = z
  ...
  .describe("Stripe invoice record (subset of Stripe API response).");
...
export const StripePaymentMethodSchema = z
  .object({
    ...
    card: z
      ...
      .optional(),
    sepa_debit: z
      .object({ last4: z.string(), bank_code: z.string().optional() })
      .optional(),
  })
  .describe("Stripe payment method (subset of Stripe API response).");
...
export const StripeSubscriptionSchema = z
  .object({
    ...
    items: z.object({
      data: z.array(
        z.object({ id: z.string(), price: z.object({ id: z.string() }) }),
      ),
    }),
  })
  .describe("Stripe subscription record (subset of Stripe API response).");

// Auto-generated from OpenAPI schema Webhooks.WebhookError. Do not edit.

export const WebhookErrorSchema = z
  .object({ message: z.string() })
  .describe("Webhook error envelope.");
