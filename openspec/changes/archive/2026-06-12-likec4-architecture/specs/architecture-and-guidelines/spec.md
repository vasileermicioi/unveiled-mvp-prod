...
- **AND** the source of truth is the LikeC4 model under `architecture/`, viewed through a LikeC4 LSP client (e.g. the [LikeC4 VS Code extension](https://marketplace.visualstudio.com/items?itemName=likec4.likec4)) or `bunx likec4 serve`
